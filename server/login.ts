...
export async function login(page: any, browser: any): Promise<void> {
  try {
...
async function clickButton(page: any, selector: string, actionDescription: string): Promise<void> {
  try {
...
async function typeText(page: any, selector: string, text: string, fieldDescription: string): Promise<void> {
  try {
...
async function removeFullScreenInfoText(page: any): Promise<void> {
  await page.evaluate(() => {
...
async function showFullScreenInfoText(page: any, mainText: string, subText: string): Promise<void> {
  await page.evaluate((overlayMainText: string, overlaySubText: string) => {
